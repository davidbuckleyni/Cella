...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cella.Models.FileAttachments", b =>
                {
                    ...
                    b.Property<int?>("StockPhotosForeignKey")
                        .HasColumnType("int");

                    b.Property<int?>("StockPhotosId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cella.Models.Permissions.AppWarehouseUserPermmissions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppWarehouseUserPermmissions");
                });
            ...
            modelBuilder.Entity("Cella.Models.StockItemVm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cella.Models.WareHouseAuditTrail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Cella.Models.FileAttachments", b =>
                {
                    b.HasOne("Cella.Models.StockItem", null)
                        .WithMany("Photos")
                        .HasForeignKey("StockItemId");

                    b.HasOne("Cella.Models.StockItemVm", "StockPhotos")
                        .WithMany("Photos")
                        .HasForeignKey("StockPhotosId");

                    b.HasOne("Cella.Models.ApplicationUser", "UploadedByUser")
                        .WithMany()
                        .HasForeignKey("UploadedBy");

                    b.Navigation("StockPhotos");
            ...
            modelBuilder.Entity("Cella.Models.Permissions.AppWarehouseUserPermmissions", b =>
                {
                    b.HasOne("Cella.Models.ApplicationUser", "UserId")
                        .WithMany()
