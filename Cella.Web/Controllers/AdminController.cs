...
namespace Warehouse.Web.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(UserManager<ApplicationUser> usrMgr, IPasswordHasher<ApplicationUser> passwordHash, IPasswordValidator<ApplicationUser> passwordVal, IUserValidator<ApplicationUser> userValid, CellaDBContext context)
        {
            userManager = usrMgr;
        ...
        public IActionResult Themes()
        {
            ...
            return View(@"~\Views\Admin\Themes\Index.cshtml",vm);
        }
